...
class Context(Model):
    ...
    """
    def __init__(self, average_size: int=None, enabled: bool=None, filestore_id: int=None, filestore_name: str=None, id: int=None, login_mappings: str=None, name: str=None, read_database: object=None, write_database: object=None, used_quota: int=None, user_attributes: object=None):
        """
