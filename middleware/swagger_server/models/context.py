...
class Context(Model):
    ...
    """
    def __init__(self, endpoint_id: int=None, average_size: int=None, enabled: bool=None, filestore_id: int=None, filestore_name: str=None, id: int=None, customid: str=None, login_mappings: str=None, max_quota: int=None, name: str=None, read_database: object=None, write_database: object=None, used_quota: int=None, user_attributes: object=None, user: User=None):
        """
        Context - a model defined in Swagger

        :param endpoint_id: The endpoint_id of this Context.
    ...
    def endpoint_id(self) -> int:
        """
        Gets the endpoint_id of this Context.
        The OXAP endpoint of the context

        :return: The endpoint_id of this Context.
        :rtype: int
        """
        return self._endpoint_id

    @endpoint_id.setter
    def endpoint_id(self, endpoint_id: int):
        """
        Sets the endpoint_id of this Context.
        The OXAP endpoint of the context
